<div x-data="{ mobileOpen: false }" class="relative" x-cloak>
  ...
  <nav class="hidden lg:flex items-center space-x-6 text-xl">
  ...
  >
    <svg x-show="!mobileOpen" class="absolute inset-0 w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" color="#D04A45" />
    </svg>
    <svg x-show="mobileOpen" class="absolute inset-0 w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
